...
${OBJECTDIR}/DiscreteMatrix.o: DiscreteMatrix.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DiscreteMatrix.o DiscreteMatrix.cpp

${OBJECTDIR}/DiscreteVectorBitMagician.o: DiscreteVectorBitMagician.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DiscreteVectorBitMagician.o DiscreteVectorBitMagician.cpp

${OBJECTDIR}/DiscreteVectorStorageInfo.o: DiscreteVectorStorageInfo.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DiscreteVectorStorageInfo.o DiscreteVectorStorageInfo.cpp

${OBJECTDIR}/DiscreteVectorValueGetterInfo.o: DiscreteVectorValueGetterInfo.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DiscreteVectorValueGetterInfo.o DiscreteVectorValueGetterInfo.cpp
...
${OBJECTDIR}/GreedyCoverCalculator.o: GreedyCoverCalculator.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GreedyCoverCalculator.o GreedyCoverCalculator.cpp

${OBJECTDIR}/RandomizationRoundRunner.o: RandomizationRoundRunner.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RandomizationRoundRunner.o RandomizationRoundRunner.cpp

${OBJECTDIR}/Semize.o: Semize.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Semize.o Semize.cpp

${OBJECTDIR}/SemizeInitializer.o: SemizeInitializer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SemizeInitializer.o SemizeInitializer.cpp

${OBJECTDIR}/Stochastic.o: Stochastic.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Stochastic.o Stochastic.cpp
